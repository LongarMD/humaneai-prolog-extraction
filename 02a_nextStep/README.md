...
Create a new set of predicates `hasGoal(person, concept or section)` and `nextStep(person, concept or section)`. The latter should give recommendations of new concepts to learn in order to get closer to the goal.
